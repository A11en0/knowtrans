...
#SBATCH -n 8
#SBATCH --gres=gpu:1
#SBATCH --output=./jellyfish-rag/logs/train50.log
...
llamafactory-cli train jellyfish-rag/scripts/upstream-train-7B/scalability/few-shot-train50.yaml
...
python jellyfish-rag/run_infer.py \
    ...
    --save_path "jellyfish-rag/results/7B/few-shot-train50" \
    --lora_weights "jellyfish-rag/outputs/7B/few-shot-train50" \
