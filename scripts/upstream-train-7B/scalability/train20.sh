...
#SBATCH -n 8
#SBATCH --gres=gpu:1
#SBATCH --output=./jellyfish-rag/logs/train20.log
...
export WANDB_NAME=knowprep-7B-weight-train20
llamafactory-cli train jellyfish-rag/scripts/upstream-train-7B/scalability/few-shot-train20.yaml
...
python jellyfish-rag/run_infer.py \
    ...
    --save_path "jellyfish-rag/results/7B/few-shot-train20" \
