...
from peft.utils import (
    TRANSFORMERS_MODELS_TO_LORAMOE_TARGET_MODULES_MAPPING,
...
class LoraMoEModel(LoraModel):
    ...
    def _prepare_adapter_config(peft_config, model_config):
        if peft_config.target_modules is None:
            if model_config["model_type"] not in TRANSFORMERS_MODELS_TO_LORAMOE_TARGET_MODULES_MAPPING:
                raise ValueError("Please specify `target_modules` in `peft_config`")
            peft_config.target_modules = TRANSFORMERS_MODELS_TO_LORAMOE_TARGET_MODULES_MAPPING[
