...
llamafactory-cli train jellyfish-rag/scripts/upstream-train-7B/few-shot-merge-weight-1e-5.yaml

export WANDB_NAME=knowprep-7B-weight-6e-4
llamafactory-cli train jellyfish-rag/scripts/upstream-train-7B/few-shot-merge-weight-6e-4.yaml

export WANDB_NAME=knowprep-7B-weight-6e-5
llamafactory-cli train jellyfish-rag/scripts/upstream-train-7B/few-shot-merge-weight-6e-5.yaml

export WANDB_NAME=knowprep-7B-weight-6e-6
llamafactory-cli train jellyfish-rag/scripts/upstream-train-7B/few-shot-merge-weight-6e-6.yaml

export WANDB_NAME=knowprep-7B-weight-8e-5
llamafactory-cli train jellyfish-rag/scripts/upstream-train-7B/few-shot-merge-weight-8e-5.yaml
...
python jellyfish-rag/run_infer.py \
    --file_path "abt_buy,ae,beers_DC,beers,cms,flights,flipkart,hospital_DC,oa,phone,rayyan_DC,rayyan,walmart_amazon" \
    --save_path "jellyfish-rag/results/7B/few-shot-train20-weight-6e-4" \
    --base_data_dir "data/Jellyfish-rag/test" \
    --model_weights "/home/yhge/pre-train/Jellyfish-7B" \
    --lora_weights "jellyfish-rag/outputs/7B/few-shot-train20-weight-6e-4" \
    --model_type "mistral" \
    --overwrite

python jellyfish-rag/run_infer.py \
    --file_path "abt_buy,ae,beers_DC,beers,cms,flights,flipkart,hospital_DC,oa,phone,rayyan_DC,rayyan,walmart_amazon" \
    --save_path "jellyfish-rag/results/7B/few-shot-train20-weight-6e-5" \
    --base_data_dir "data/Jellyfish-rag/test" \
    --model_weights "/home/yhge/pre-train/Jellyfish-7B" \
    --lora_weights "jellyfish-rag/outputs/7B/few-shot-train20-weight-6e-5" \
    --model_type "mistral" \
    --overwrite
