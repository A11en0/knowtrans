...
export WANDB_NAME=mistral-7B-beers
llamafactory-cli train jellyfish-rag/scripts/upstream-train-7B/beers.yaml

# Set wandb and run scripts
export WANDB_NAME=mistral-7B-buy
llamafactory-cli train jellyfish-rag/scripts/upstream-train-7B/buy.yaml
