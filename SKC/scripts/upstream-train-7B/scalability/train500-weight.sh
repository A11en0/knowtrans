...
#SBATCH -J train500-weight
#SBATCH -p a40-high
#SBATCH -N 1
#SBATCH -n 8
#SBATCH --gres=gpu:1
#SBATCH --output=./jellyfish-rag/logs/train500-weight.log
...
llamafactory-cli train jellyfish-rag/scripts/upstream-train-7B/scalability/few-shot-train500-weight.yaml
...
python jellyfish-rag/run_infer.py \
    ...
    --save_path "jellyfish-rag/results/7B/few-shot-train500-weight" \
    --lora_weights "jellyfish-rag/outputs/7B/few-shot-train500-weight" \
