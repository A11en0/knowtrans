...
#SBATCH -J train1000-weight
#SBATCH -p a40
#SBATCH -N 1
#SBATCH -n 8
#SBATCH --gres=gpu:1
#SBATCH --output=./jellyfish-rag/logs/train1000-weight.log
...
llamafactory-cli train jellyfish-rag/scripts/upstream-train-7B/scalability/few-shot-train1000-weight.yaml
...
python jellyfish-rag/run_infer.py \
    ...
    --save_path "jellyfish-rag/results/7B/few-shot-train1000-weight" \
    --lora_weights "jellyfish-rag/outputs/7B/few-shot-train1000-weight" \
