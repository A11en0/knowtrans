...
llamafactory-cli train jellyfish-rag/scripts/upstream-train/adult.yaml

# Set wandb and run scripts
export WANDB_NAME=llama3-1B-amazon_google
llamafactory-cli train jellyfish-rag/scripts/upstream-train/amazon_google.yaml

# Set wandb and run scripts
export WANDB_NAME=llama3-1B-beers
llamafactory-cli train jellyfish-rag/scripts/upstream-train/beers.yaml

# Set wandb and run scripts
export WANDB_NAME=llama3-1B-buy
llamafactory-cli train jellyfish-rag/scripts/upstream-train/buy.yaml

# Set wandb and run scripts
export WANDB_NAME=llama3-1B-dblp_acm
llamafactory-cli train jellyfish-rag/scripts/upstream-train/dblp_acm.yaml

# Set wandb and run scripts
export WANDB_NAME=llama3-1B-dblp_scholar
llamafactory-cli train jellyfish-rag/scripts/upstream-train/dblp_scholar.yaml

# Set wandb and run scripts
export WANDB_NAME=llama3-1B-fodors_zagat
llamafactory-cli train jellyfish-rag/scripts/upstream-train/fodors_zagat.yaml

# Set wandb and run scripts
export WANDB_NAME=llama3-1B-hospital
llamafactory-cli train jellyfish-rag/scripts/upstream-train/hospital.yaml

# Set wandb and run scripts
export WANDB_NAME=llama3-1B-itunes_amazon
llamafactory-cli train jellyfish-rag/scripts/upstream-train/itunes_amazon.yaml

# Set wandb and run scripts
export WANDB_NAME=llama3-1B-restaurant
llamafactory-cli train jellyfish-rag/scripts/upstream-train/restaurant.yaml

# Set wandb and run scripts
export WANDB_NAME=llama3-1B-sm
llamafactory-cli train jellyfish-rag/scripts/upstream-train/sm.yaml
