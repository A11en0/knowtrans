...
class LoraModel(BaseTuner):
    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        from peft.tuners.moelora import MoELoraLayer
        
        if isinstance(target, LoraLayer) and not isinstance(target, AdaLoraLayer) and not isinstance(target, MoELoraLayer):
            target.update_layer(
                adapter_name,
                r,
                lora_alpha=alpha,
